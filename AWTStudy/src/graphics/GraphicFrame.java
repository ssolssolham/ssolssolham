...
public class GraphicFrame extends Frame {
	...
	public GraphicFrame() {
		...
		try {
			url = new URL("https://t1.daumcdn.net/midas/new/creative/224926/2017000/ggd0827_655x120.jpg");
	...
	/*
	 * 모든 컴포넌트가 처음 화면에 보여질 때, 리사이징될 때, 활성화/비활성화 될 때 JVM에 자동으로 호출되는 그래픽 처리 콜백메소드
	 * (java.awt.Component 클래스에 정의)로 사용자가 그래픽을 처리하고자 할 경우 paint(Graphics g)를 오버라이딩
	 * 한다. 인자로 주어지는 Graphics는 그래픽 처리에 필요한 도구 제공(붓 역할)
	 */
