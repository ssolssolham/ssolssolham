...
public class Validator {
	...
	public static boolean isValidId(String id){
		if(Pattern.matches("^[a-zA-Z0-9가-힣]{8,10}", id)) {
			return true;
		}
		return false;
	}
	...
	public static boolean isValidPhoneNumber(String number) {
		if(Pattern.matches("^[0-9]{2,3}-[0-9]{3,4}-[0-9]{4}$", number)) {
			return true;
		}
		return false;
	}
	...
	public static boolean isValidMobileNumber(String number) {
		if(Pattern.matches("^01(0|1|[6-9])-[0-9]{3,4}-[0-9]{4}", number)) {
			return true;
		}
		return false;
	}
	...
	public static boolean isValidSSN(String ssn) {
		if(Pattern.matches("[0-9]{6}-[1-4]{1}[0-9]{6}", ssn)) {
			return true;
		}
		return false;
	}
	...
	public static boolean isValidFile(String fileName) {
		if(Pattern.matches("[a-zA-Z0-9]+((\\.(?i)(png|gif))$)", fileName)) {
			return true;
		}
		return false;
	}
